...
<head>
  ...
  <title>OpenAPI Enforcer | V2 Components</title>
    ...
    <div class="page-content-main">
      <article class="post">
        <header class="post-header">
          ...
          <h1 class="post-title">V2 Components</h1>
        </header>
...
<li>Xml</li>
      ...
      <footer class="site-footer">
        ...
        <p>
          ...
          <a href="https://github.com/byu-oit/openapi-enforcer/tree/master/docs-src/api/components/v2_0-components.md" target="_blank" rel="noopener">Edit this page on Github</a>
        </p>
