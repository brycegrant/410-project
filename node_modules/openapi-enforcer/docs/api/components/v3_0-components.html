...
<head>
  ...
  <title>OpenAPI Enforcer | V3 Components</title>
    ...
    <div class="page-content-main">
      <article class="post">
        <header class="post-header">
          ...
          <h1 class="post-title">V3 Components</h1>
        </header>
...
<li>Xml</li>
      ...
      <footer class="site-footer">
        ...
        <p>
          ...
          <a href="https://github.com/byu-oit/openapi-enforcer/tree/master/docs-src/api/components/v3_0-components.md" target="_blank" rel="noopener">Edit this page on Github</a>
        </p>
