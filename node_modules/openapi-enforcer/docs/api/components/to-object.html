...
<head>
  ...
  <title>OpenAPI Enforcer | To Object</title>
    ...
    <div class="page-content-main">
      <article class="post">
        <header class="post-header">
          ...
          <h1 class="post-title">To Object</h1>
        </header>

        
        <div>
          <p><strong>Page Content</strong></p>
          <div class="section-nav"><ul class="toc"><li><a href="#toobject">toObject</a></li></ul></div>
        </div>
        

        <div class="post-content"><h2 id="toobject">toObject</h2>
...
<p><strong>Returns:</strong> A plain object</p>
      ...
      <footer class="site-footer">
        ...
        <p>
          ...
          <a href="https://github.com/byu-oit/openapi-enforcer/tree/master/docs-src/api/components/to-object.md" target="_blank" rel="noopener">Edit this page on Github</a>
        </p>
